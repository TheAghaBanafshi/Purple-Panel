...
# Customized by @AghaBanafshi | Original: github.com/x4gking
...
:root{--bg:#0f081a;--card:rgba(20,10,40,0.92);--accent:#8B5CF6;--text:#F0E8FF;--dim:#6D4A9E;--mid:#A78BFA;--border:rgba(139,92,246,0.25)}
...
.bg{position:fixed;inset:0;background:radial-gradient(ellipse 80% 60% at 50% 0%,rgba(139,92,246,0.15),transparent 70%),var(--bg);z-index:0}
.grid{position:fixed;inset:0;background-image:linear-gradient(rgba(139,92,246,0.05) 1px,transparent 1px),linear-gradient(90deg,rgba(139,92,246,0.05) 1px,transparent 1px);background-size:44px 44px;z-index:0}
.orb{position:fixed;border-radius:50%;filter:blur(90px);z-index:0;animation:fl 9s ease-in-out infinite}
.o1{width:380px;height:380px;background:rgba(139,92,246,0.08);top:-100px;right:-80px}
.o2{width:280px;height:280px;background:rgba(139,92,246,0.04);bottom:-60px;left:-60px;animation-delay:4s}
...
.card{background:var(--card);border:1px solid var(--border);border-radius:20px;padding:38px 34px 34px;backdrop-filter:blur(24px);box-shadow:0 0 80px rgba(139,92,246,0.1),0 20px 60px rgba(0,0,0,.5)}
.brand{display:flex;align-items:center;gap:14px;margin-bottom:28px}
.brand-icon{width:48px;height:48px;border-radius:50%;background:linear-gradient(135deg,#8B5CF6,#6D28D9);display:flex;align-items:center;justify-content:center;color:#fff;font-size:24px;flex-shrink:0;box-shadow:0 0 30px rgba(139,92,246,0.4)}
...
.hint{display:flex;align-items:center;gap:10px;background:rgba(139,92,246,0.08);border:1px solid rgba(139,92,246,0.2);border-radius:10px;padding:10px 14px;margin-bottom:20px}
.hint-label{font-size:11px;color:var(--dim);flex:1}
.hint-val{font-family:ui-monospace,monospace;font-size:14px;font-weight:700;color:var(--accent);background:rgba(139,92,246,0.15);border:1px solid rgba(139,92,246,0.3);padding:3px 11px;border-radius:7px;cursor:pointer;transition:.15s;letter-spacing:.08em}
.hint-val:hover{background:rgba(139,92,246,0.25)}
...
input[type=password]:focus{border-color:rgba(139,92,246,.6);background:rgba(0,0,0,.4);box-shadow:0 0 0 3px rgba(139,92,246,.15)}
...
.btn{width:100%;padding:13px;border-radius:11px;border:none;cursor:pointer;background:linear-gradient(135deg,#8B5CF6,#6D28D9);color:#fff;font-family:inherit;font-size:14px;font-weight:600;display:flex;align-items:center;justify-content:center;gap:8px;box-shadow:0 4px 24px rgba(139,92,246,.4);transition:.2s;position:relative;overflow:hidden}
.btn::before{content:'';position:absolute;inset:0;background:rgba(255,255,255,.08);opacity:0;transition:.2s}
.btn:hover::before{opacity:1}
.btn:disabled{opacity:.5;cursor:not-allowed}
.footer{margin-top:22px;padding-top:18px;border-top:1px solid var(--border);display:flex;align-items:center;justify-content:center;gap:6px;font-size:10px;color:var(--dim);flex-direction:column;line-height:1.8}
.footer a{color:var(--accent);font-weight:600;text-decoration:none;display:inline-flex;align-items:center;gap:4px}
.footer .credit{font-size:9px;color:var(--dim);opacity:0.7}
...
<div class="wrap">
  <div class="card">
    <div class="brand">
      ...
      <div><div class="brand-name">Purple-Panel</div><div class="brand-sub">v1.0</div></div>
    </div>
    <h1>ورود به پنل</h1>
    ...
    <div class="hint">
      ...
      <span class="hint-val" onclick="document.getElementById('pw').value='PurplePanel';document.getElementById('pw').focus()">PurplePanel</span>
    </div>
    <form id="form">
      <div class="field">
...
*{margin:0;padding:0;box-sizing:border-box}
:root{
  --bg:#0f081a;--bg2:#1a0e30;--bg3:#251040;
  --card:#160c28;--card-b:rgba(139,92,246,0.15);--card-bh:rgba(139,92,246,0.35);
...
.logo-icon{width:38px;height:38px;border-radius:50%;background:linear-gradient(135deg,#8B5CF6,#6D28D9);display:flex;align-items:center;justify-content:center;color:#fff;font-size:20px;flex-shrink:0;box-shadow:0 0 20px rgba(139,92,246,.35)}
.logo-name{font-size:13.5px;font-weight:700;color:var(--t1);letter-spacing:-.02em}
...
.mob-logo{width:28px;height:28px;border-radius:50%;background:linear-gradient(135deg,#8B5CF6,#6D28D9);display:flex;align-items:center;justify-content:center;color:#fff;font-size:14px;flex-shrink:0}
...
.btn-p:hover{background:#7C3AED;box-shadow:0 4px 18px rgba(139,92,246,.4)}
...
.cp-head-icon{width:44px;height:44px;border-radius:13px;background:linear-gradient(135deg,#8B5CF6,#6D28D9);display:flex;align-items:center;justify-content:center;color:#fff;font-size:20px;flex-shrink:0;box-shadow:0 6px 18px rgba(139,92,246,.35)}
...
.cp-submit-btn{background:linear-gradient(135deg,#8B5CF6,#6D28D9);color:#fff;border:none;border-radius:13px;padding:13px 26px;font-family:inherit;font-size:13px;font-weight:800;cursor:pointer;display:flex;align-items:center;gap:8px;box-shadow:0 6px 20px rgba(139,92,246,.35);transition:.18s;white-space:nowrap}
...
.srv-hero-icon{width:50px;height:50px;border-radius:14px;background:linear-gradient(135deg,#8B5CF6,#6D28D9);display:flex;align-items:center;justify-content:center;color:#fff;font-size:22px;flex-shrink:0;box-shadow:0 6px 18px rgba(139,92,246,.35)}
...
.pw-hero-icon{width:50px;height:50px;border-radius:14px;background:linear-gradient(135deg,#8B5CF6,#6D28D9);display:flex;align-items:center;justify-content:center;color:#fff;font-size:22px;flex-shrink:0;box-shadow:0 6px 18px rgba(139,92,246,.35)}
...
.sub-card-icon{width:46px;height:46px;border-radius:14px;background:linear-gradient(135deg,#8B5CF6,#6D28D9);display:flex;align-items:center;justify-content:center;color:#fff;font-size:20px;flex-shrink:0;box-shadow:0 6px 16px rgba(139,92,246,.35)}
...
.modal-v2-icon{width:42px;height:42px;border-radius:13px;background:linear-gradient(135deg,#8B5CF6,#6D28D9);display:flex;align-items:center;justify-content:center;color:#fff;font-size:19px;margin-bottom:10px;position:relative;z-index:1;box-shadow:0 8px 18px rgba(139,92,246,.4)}
...
.modal-v2-btn-submit{flex:1;justify-content:center;padding:10px;border-radius:11px;background:linear-gradient(135deg,#8B5CF6,#6D28D9);color:#fff;border:none;font-family:inherit;font-size:12px;font-weight:800;cursor:pointer;display:flex;align-items:center;gap:6px;box-shadow:0 6px 18px rgba(139,92,246,.4);transition:.18s}
...
.lmodal-icon{width:44px;height:44px;border-radius:13px;background:linear-gradient(135deg,#8B5CF6,#6D28D9);display:flex;align-items:center;justify-content:center;color:#fff;font-size:19px;flex-shrink:0;box-shadow:0 6px 16px rgba(139,92,246,.35)}
...
<aside class="sidebar" id="sb">
  ...
  <div class="logo">
    ...
    <div><div class="logo-name">Purple-Panel</div><div class="logo-sub">v1.0</div></div>
  </div>
  <div class="nav-wrap">
...
<section class="pg" id="pg-support">
  ...
  <div class="srv-panel">
    <div class="srv-hero">
      ...
      <div class="srv-hero-text">
        <div class="srv-hero-domain">پشتیبانی Purple-Panel</div>
...
function initCharts(){
  ...
  const opts={
    ...
    plugins:{
      ...
      tooltip:{
        backgroundColor:'rgba(20,10,40,.96)',borderColor:'rgba(139,92,246,.3)',borderWidth:1,
        titleColor:'#F0E8FF',bodyColor:'#9C8ABF',padding:11,cornerRadius:10,displayColors:false,
    ...
    scales:{
      x:{grid:{display:false},border:{display:false},ticks:{color:'#6D4A9E',font:{size:9,family:'Vazirmatn'}}},
      y:{grid:{color:'rgba(139,92,246,.06)'},border:{display:false},ticks:{color:'#6D4A9E',font:{size:9,family:'Vazirmatn'},callback:v=>v+' MB'}}
    },
  ...
  ch3=new Chart(document.getElementById('ch3'),{
    ...
    options:{
      ...
      plugins:{
        legend:{display:false},
        tooltip:{
          backgroundColor:'rgba(20,10,40,.97)',borderColor:'rgba(139,92,246,.35)',borderWidth:1,
          titleColor:'#F0E8FF',bodyColor:'#B8A6D8',padding:13,cornerRadius:12,displayColors:true,boxPadding:4,
      ...
      scales:{
        x:{grid:{display:false},border:{display:false},ticks:{color:'#6D4A9E',font:{size:9.5,family:'Vazirmatn'},maxRotation:0}},
        y:{grid:{color:'rgba(139,92,246,.05)'},border:{display:false},ticks:{color:'#6D4A9E',font:{size:9.5,family:'Vazirmatn'},callback:v=>v+' MB'}}
      }
    }
  });
  ...
  ch2=new Chart(document.getElementById('ch2'),{
    ...
    data:{labels:['VLESS/WS','XHTTP Ultra','HTTP Proxy'],datasets:[{
      data:[55,35,10],
      backgroundColor:['#8B5CF6','#10B981','#6D28D9'],
      borderColor:getComputedStyle(document.documentElement).getPropertyValue('--card')||'#160c28',
    ...
    options:{
      ...
      plugins:{
        ...
        tooltip:{backgroundColor:'rgba(20,10,40,.96)',borderColor:'rgba(139,92,246,.3)',borderWidth:1,padding:10,cornerRadius:10,bodyFont:{family:'Vazirmatn'},titleFont:{family:'Vazirmatn'}}
      }
    }
  });
}
let ws;
function wsLog(c,m){const l=document.getElementById('ws-log'),p=document.createElement('p');const colors={ok:'#34D399',err:'#F87171',info:'#9C8ABF',sent:'#FCD34D'};p.style.color=colors[c]||'#fff';p.textContent='['+new Date().toLocaleTimeString('fa-IR')+'] '+m;l.appendChild(p);l.scrollTop=l.scrollHeight}
...
[data-theme="light"]{{
  ...
  --purple:#7C3AED;--purple-bg:rgba(124,58,237,0.08);
  --t1:#1A0E30;--t2:#4A2D6E;--t3:#7A5DA6;
  --shadow:0 12px 36px rgba(80,40,160,0.12);
}}
...
.brand-icon{{width:40px;height:40px;border-radius:50%;background:linear-gradient(135deg,#8B5CF6,#6D28D9);display:flex;align-items:center;justify-content:center;color:#fff;font-size:20px;flex-shrink:0;box-shadow:0 0 20px rgba(139,92,246,.35)}}
...
.footer{{text-align:center;padding-top:28px;font-size:10.5px;color:var(--t3);line-height:2}}
